...
@protocol CustomUIAlertViewDelegate;

@interface CustomUIAlertView : UIView
...
@property(nonatomic,weak) id<CustomUIAlertViewDelegate> delegate;    // weak reference

//@property (nonatomic, weak) id <CustomUIAlertViewDelegate> iOSDelegate;
...
@property(nonatomic, assign) UIView *alertContentContainer;
...
@property(nonatomic, assign, readonly) UIView *backgroundOverlay;
@property(nonatomic, assign, readonly) UIView *alertContainer;
...
@protocol CustomUIAlertViewDelegate <NSObject>
@optional
...
// TODO: not implemented
//- (void)alertViewCancel:(CustomUIAlertView *)alertView;

- (void)willPresentAlertView:(CustomUIAlertView *)alertView;  // before animation and showing view
- (void)didPresentAlertView:(CustomUIAlertView *)alertView;  // after animation

- (void)alertView:(CustomUIAlertView *)alertView willDismissWithButtonIndex:(NSInteger)buttonIndex; // before animation and hiding view
- (void)alertView:(CustomUIAlertView *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex;  // after animation
